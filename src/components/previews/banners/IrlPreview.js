  ...
  render() {
    ...
    return (
      <div className={styles.root}>
        ...
        <div>
          <p>
            To save the position you have warped the ad into, replace the
            current <code>nmatrsanitix</code> array in your preview component
            with this new <code>nmatrix</code> array:
          </p>
          <pre className={styles.nmatrix}>
            nmatrix = {JSON.stringify(nmatrix)}
          </pre>
        </div>
      </div>
    )
